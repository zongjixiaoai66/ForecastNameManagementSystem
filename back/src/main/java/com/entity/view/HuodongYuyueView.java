	...
	*/
	...
	//级联表 报考活动
		...
		*/
		...
		@ColumnInfo(comment="报考活动编号",type="varchar(200)")
		private String huodongUuidNumber;
		/**
		* 报考活动名称
		*/

		@ColumnInfo(comment="报考活动名称",type="varchar(200)")
		...
		*/
		...
		@DateTimeFormat
		@ColumnInfo(comment="截至时间",type="timestamp")
		...
		* 报考活动类型
		*/
		@ColumnInfo(comment="报考活动类型",type="int(11)")
		private Integer huodongTypes;
			/**
			* 报考活动类型的值
			*/
			@ColumnInfo(comment="报考活动类型的字典表值",type="varchar(200)")
			private String huodongValue;
		/**
		* 报考活动热度
		*/

		@ColumnInfo(comment="报考活动热度",type="int(11)")
		private Integer huodongClicknum;
		/**
		* 报考活动介绍
		*/

		@ColumnInfo(comment="报考活动介绍",type="longtext")
