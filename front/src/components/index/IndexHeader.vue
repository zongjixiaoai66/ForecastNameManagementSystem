    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {},
                user: {},
                heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"var(--publicMainColor)","headBoxShadow":"0 1px 6px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"var(--publicMainColor)","headFontColor":"var(--publicMainColor)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headBgColor":"#FBFBFB","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"var(--publicMainColor)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
            };
        },
        created() {
            this.setHeaderStyle()
