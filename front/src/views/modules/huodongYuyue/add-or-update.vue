        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="报考活动" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择报考活动" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报考活动编号" prop="huodongUuidNumber">
                        <el-input v-model="huodongForm.huodongUuidNumber"
                                  placeholder="报考活动编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报考活动编号" prop="huodongUuidNumber">
                            <el-input v-model="ruleForm.huodongUuidNumber"
                                      placeholder="报考活动编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报考活动名称" prop="huodongName">
                        <el-input v-model="huodongForm.huodongName"
                                  placeholder="报考活动名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报考活动名称" prop="huodongName">
                            <el-input v-model="ruleForm.huodongName"
                                      placeholder="报考活动名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='huodong' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="截至时间" prop="jiezhiTime">
                        <el-input v-model="huodongForm.jiezhiTime"
                                  placeholder="截至时间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="截至时间" prop="jiezhiTime">
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报考活动类型" prop="huodongValue">
                        <el-input v-model="huodongForm.huodongValue"
                                  placeholder="报考活动类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报考活动类型" prop="huodongValue">
                            <el-input v-model="ruleForm.huodongValue"
                                      placeholder="报考活动类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="报考活动热度" prop="huodongClicknum">
                        <el-input v-model="huodongForm.huodongClicknum"
                                  placeholder="报考活动热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报考活动热度" prop="huodongClicknum">
                            <el-input v-model="ruleForm.huodongClicknum"
                                      placeholder="报考活动热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名意愿" prop="huodongYuyueText">
                        <el-input type="textarea"  :readonly="ro.huodongYuyueText" v-model="ruleForm.huodongYuyueText" placeholder="报名意愿"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huodongYuyueText" label="报名意愿" prop="huodongYuyueText">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huodongYuyueText: [
                              { required: true, message: '报名意愿不能为空', trigger: 'blur' },
                          ],
                   huodongYuyueYesnoTypes: [
